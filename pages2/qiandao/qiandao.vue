	...
	<view>
		...
		<view style="width: 750rpx;background-color: white;z-index: 100000;position: fixed;top: 0rpx;" :style="{
			...
			<view class="topviewbutton roww rowsb center_center" :style="{
				...
				<view>签到</view>
				<image src="/static/zuojiantou.png" class="w-30 h-30 m-left-40"></image>
			</view>

		</view>

		<view class="colonn" style="position: relative;height: 1100rpx;">
			<image src="https://shandongtibohui.zsyflive.com/profile/沉浸式背景.png" class="w-750 " style="height: 1100rpx;">
			</image>
			<view class="topviewbutton roww rowsb center_center" :style="{
					'height':buttoninfo.height+'px',
					'top':buttoninfo.top+'px',
			...
			<view class="roww center_center w-750" style="z-index: 1000;position: absolute;" :style="{
				...
				<view class="colonn" style="color: white;">
					...
					<view class="roww fs-30 duiqi">
						<view>当前积分：</view>
						<view class="fs-45">77</view>
						<view>积分</view>
					</view>
				</view>
				<view class="allline"></view>
				<image src="/static/quduihuan.png" class="w-150" mode="widthFix"></image>
			</view>
			<view class="rilivie colonn" :style="{
					'top':(buttoninfo.top+150)+'px',
				}">
				<view class="roww rowsb p-all-30">
					<image src="../../static/zuoh.png" class="w-50 h-50"></image>
					<view class="roww w-250 center_center months">
						<view style="color: #FE236C;font-weight: bold;">十一月</view>
					</view>
					<image src="../../static/youh.png" class="w-50 h-50"></image>
				</view>
				<view class="huanhang p-all-20 rowsb">
					<view class="dayviewno" v-for="(item,index) in 30">01</view>
				</view>
				<view class="roww center_center">
					<image src="/static/lijiqiandao.png" class="w-200" mode="widthFix"></image>
				</view>
